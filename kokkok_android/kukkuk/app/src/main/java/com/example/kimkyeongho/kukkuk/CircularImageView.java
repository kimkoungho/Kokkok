...
public class CircularImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes.getBoolean(R.styleable.CircularImageView_civ_border, true)) {
            ...
            setBorderColor(attributes.getColor(R.styleable.CircularImageView_civ_border_color, getResources().getColor(R.color.white)));
            //수정
        }
    ...
    public void setScaleType(ScaleType scaleType) {
        if (scaleType != SCALE_TYPE) {//CENTER_CROP
            throw new IllegalArgumentException(String.format("ScaleType %s not supported. ScaleType.CENTER_INSIDE is used by default. So you don't need to use ScaleType.", scaleType));
        }
    }
    //endregion
