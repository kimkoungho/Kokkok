...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setting = getSharedPreferences("permissionSetting", 0);
        editor=setting.edit();

        finishFlag=setting.getBoolean("permission",false);
        ...
        Glide.with(this).load(R.drawable.kok_splash).into(imageViewTarget01);
