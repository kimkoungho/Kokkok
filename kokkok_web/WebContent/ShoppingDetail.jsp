...
<%
	...
	HashMap<String, Object> hash = sd.getShoppingInfo(shop_no);
	
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");

	ArrayList<String> img_list = id.getImageURLList(kind, shop_no);
	int recommend_cnt = rd.getRecommendCount(kind, shop_no);
	int scrap_cnt = mid.getScrapCount(kind, shop_no);
	boolean isRecommend = rd.isRecommend(nickName, kind, shop_no);
	boolean isScrap = mid.isScrap(nickName, kind, shop_no);
	
	ArrayList<HashMap<String, Object>> comment_list = cmd.getDB(kind, shop_no, 1);
%>
...
<body>
	...
	<div id="header">
		<div id="title">
			<span class="title_text">
	        	<%=((String)hash.get("shop_no")).substring(0,2)%> > 
	        	<%=hash.get("name")%>
	        </span>
	    ...
	    <div class="area_text">
	        ...
	        <div class="area_info1">
		        ...
		        <div class="area_info_content">
		            ...
		            <span class="info_insert">쇼핑</span>
		        </div>
    ...
    <iframe src="Comment.jsp?kind=shopping&item_id=<%=shop_no%>&level=1" id="dynamic" style="display:none" name="dynamic"></iframe>
